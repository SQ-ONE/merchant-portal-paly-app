package com.squareoneinsights.merchantportal.marchantportalapp.api
...
object MarchantportalappService  {
  val TOPIC_NAME = "greetings"
}

/**
  * The marchant-portal-app service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the MarchantportalappService.
  */
trait MarchantportalappService extends Service {
  ...
  override final def descriptor: Descriptor = {
    import Service._
    // @formatter:off
    named("marchant-portal-app")
      .withCalls(
        pathCall("/api/hello/:id", hello _),
        pathCall("/api/hello/:id", useGreeting _)
      )
      .withTopics(
        topic(MarchantportalappService.TOPIC_NAME, greetingsTopic _)
